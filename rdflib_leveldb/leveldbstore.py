...
class LevelDBStore(Store):
    ...
    def namespaces(self):
        for prefix, uri in self._LevelDBStore__namespace.RangeIter():
            yield prefix.decode('utf-8'), uri.decode('utf-8')
    ...
    def contexts(self, triple=None):
        ...
        if triple:
            ...
            for (k, v) in self._LevelDBStore__contexts.RangeIter():
